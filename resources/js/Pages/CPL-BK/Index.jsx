                ...
                <Card>
                    ...
                    <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                        {cpls.length === 0 ? (
                            <EmptyState
                                icon={IconArrowsSplit}
                                title="Tidak ada pemetaan CPL-BK"
                                subtitle="Mulailah dengan membuat pemetaan CPL-BK baru"
                            />
                        ) : (
                                    ...
                                    {cpls.map((cpl, index) => (
                                        <TableRow key={cpl.id}>
                                            ...
                                            <TableCell>
                                                ...
                                                {cpl.studyMaterials && cpl.studyMaterials.length > 0 ? (
                                                    <div className="flex flex-wrap gap-1">
                                                        {/* Lakukan perulangan dan tampilkan sebagai Badge */}
                                                        {cpl.studyMaterials.map((bk) => (
                                                            <Tooltip key={bk.id}>
                                                                <TooltipTrigger>
                                                                    <Badge variant="secondary">{bk.code}</Badge>
                                                                </TooltipTrigger>
                                                                <TooltipContent>
                                                                    <p>{bk.description}</p>
                                                                </TooltipContent>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-x-1">
                                                    <Button variant="blue" size="sm" asChild>
                                                        <Link href={route('cpl-bk.edit', [cpl])}>
                                                    ...
                                                    <AlertAction
                                                        ...
                                                        action={() => deleteAction(route('cpl-bk.destroy', [cpl]))}
                                                    />
                                                </div>
                                            </TableCell>
                                        </TableRow>
