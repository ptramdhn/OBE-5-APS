                ...
                <Card>
                    <CardHeader className="p-0">
                        <div className="flex flex-col items-start justify-between gap-y-4 p-4 lg:flex-row lg:items-center">
                            ...
                            <Button variant="blue" size="xl" asChild>
                                <Link href={route('cpl-cpmk.create')}>
                    ...
                    <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                        {cpls.length === 0 ? (
                            <EmptyState
                                icon={IconArrowsSplit}
                                title="Tidak ada pemetaan CPL-CPMK"
                                subtitle="Mulailah dengan membuat pemetaan CPL-CPMK baru"
                            />
                        ) : (
                            <Table className="w-full">
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead>CPMK Terhubung</TableHead> {/* <-- 1. TAMBAH HEADER BARU */}
                                    ...
                                    {cpls.map((cpl, index) => (
                                        <TableRow key={cpl.id}>
                                            ...
                                            <TableCell>
                                                ...
                                                {cpl.cpmks && cpl.cpmks.length > 0 ? (
                                                    <div className="flex flex-wrap gap-1">
                                                        {/* Lakukan perulangan dan tampilkan sebagai Badge */}
                                                        {cpl.cpmks.map((cpmk) => (
                                                            <Tooltip key={cpmk.id}>
                                                                <TooltipTrigger>
                                                                    <Badge variant="secondary">{cpmk.code}</Badge>
                                                                </TooltipTrigger>
                                                                <TooltipContent>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-x-1">
                                                    <Button variant="blue" size="sm" asChild>
                                                        <Link href={route('cpl-cpmk.edit', [cpl])}>
                                                    ...
                                                    <AlertAction
                                                        ...
                                                        action={() => deleteAction(route('cpl-cpmk.destroy', [cpl]))}
                                                    />
                                                </div>
                                            </TableCell>
                                        </TableRow>
