...
import { IconArrowBack, IconChecks } from '@tabler/icons-react';
import { toast } from 'sonner';

export default function Edit(props) {
    const { data, setData, errors, post, processing, reset } = useForm({
        prodi_id: props.programLearningOutcome?.prodi_id ?? null,
        code: props.programLearningOutcome?.code ?? '',
        description: props.programLearningOutcome?.description ?? '',
                ...
                <CardHeader>
                    <div className="flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                        ...
                        <Button variant="blue" size="xl" asChild>
                            <Link href={route('program-learning-outcomes.index')}>
