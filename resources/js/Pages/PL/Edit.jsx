...
import { IconArrowBack, IconAward, IconChecks } from '@tabler/icons-react';
import { toast } from 'sonner';

export default function Edit(props) {
    const { data, setData, errors, post, processing, reset } = useForm({
        prodi_id: props.graduateProfile?.prodi_id ?? null,
        code: props.graduateProfile?.code ?? '',
        description: props.graduateProfile?.description ?? '',
            ...
            <Card>
                <CardHeader>
                    <div className="flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                        ...
                        <Button variant="blue" size="xl" asChild>
                            <Link href={route('graduate-profiles.index')}>
                ...
                <CardContent>
                    <form className="space-y-4" onSubmit={onHandleSubmit}>
                        ...
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="code">Kode PL</Label>
                            <Input
                                type="text"
                                name="code"
                                id="code"
                                placeholder="Masukkan Kode PL"
                                value={data.code}
