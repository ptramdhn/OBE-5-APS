...
export default function Create(props) {
    const { cpls, mks } = props;

    const [filteredCpls, setFilteredCpls] = useState(cpls);

    // 1. STRUKTUR STATE: `bk_ids` adalah array untuk menampung dropdown dinamis
    const { data, setData, errors, post, processing, reset } = useForm({
        mk_id: '',
        cpl_ids: [{ id: Date.now(), value: '' }], // Mulai dengan satu dropdown BK
    });
                            ...
                            <Select
                                ...
                                onValueChange={(value) => {
                                    ...
                                    setData((currentData) => ({
                                        ...currentData,
                                        mk_id: value,
                                        cpl_ids: [{ id: Date.now(), value: '' }],
                                    }));
                                }}
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Pilih MK yang akan dipetakan" />
                                </SelectTrigger>
                                <SelectContent>
